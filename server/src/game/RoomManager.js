...
export class RoomManager {
  ...
  privateState(roomOrPlayer, maybePlayer) {
    ...
    return { playerId:player.id, reconnectToken:player.reconnectToken, role: player.role ? roles.roles[player.role] : null, hand:player.hand, peekedGoals:player.peekedGoals, aiControlled:Boolean(player.aiControlled), goldDraft:draft };
  }
